var PATH = require('path'),
    ...
    PRJ_TECHS = PATH.resolve(PRJ_ROOT, '.bem/techs') // , Закомментировано мной
...
exports.getTechs = function() {
    var techs = {
       ...
       // 'ie8.css'       : 'v2/ie8.css',
       // 'ie9.css'       : 'v2/ie9.css',
        'js'            : 'v2/js-i' //,		Закомментировано мной
       // 'bemdecl.js'    : 'v2/bemdecl.js', Закомментировано мной
       // 'deps.js'       : 'v2/deps.js'		Закомментировано мной
    };

    // использовать технологии из проекта (.bem/techs)
    ['bemjson.js'].forEach(getTechResolver(techs, PRJ_TECHS));

    // использовать технологии из bem-bl библиотеки. Закомментировано мной
